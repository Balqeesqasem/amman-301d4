...
function displayPics(){
  ...
  //console.log(rando);
  // TODO: In a sentence or two, explain why the previous line of code threw an error when we changed the iable declaration from `const to `const`.
  //rando declared inside function so console will not see it because we trying to call it out side the function as aglobal but its not.
  console.log(viewed);
